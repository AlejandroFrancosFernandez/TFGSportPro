...
object LowIntensityExercises {
    //Calentamientos
    val highKnees = Exercise(R.string.high_Knees, 30, R.drawable.ehighknees)
    val jumpingJacks = Exercise(R.string.jumping_Jacks, 30, R.drawable.ejumpingjacks)
    val jumpingSquats = Exercise(R.string.jumping_Squats, 30, R.drawable.ejumpingsquats)
    val jumpingInPlace = Exercise(R.string.jumping_In_Place, 30)
    val lowSkipping = Exercise(R.string.low_Skipping, 30, R.drawable.elowskipping)
    //Ejercicios
    val BREAK = Exercise(R.string.BREAK, 30, R.drawable.edescanso)
    val lunges = Exercise(R.string.lunges, 30, R.drawable.elunges)
    val heelRaises = Exercise(R.string.heel_Raises, 30, R.drawable.eheelraises)
    val kneePushUps = Exercise(R.string.knee_Push_Ups, 30, R.drawable.ekneepushups)
    ...
    val elbowPlank = Exercise(R.string.elbow_Plank, 30, R.drawable.eelbowplank)
    ...
    val plank = Exercise(R.string.plank, 30, R.drawable.eplank)
...
object HighIntensityExercises {
    ...
    val burpeesHigh = Exercise(R.string.burpees, 35, R.drawable.eburpee)
    ...
    val heelTapCrunchesHigh = Exercise(R.string.heel_Tap_Crunches, 35, R.drawable.eheeltapcrunches)
